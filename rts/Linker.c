...
#define RTS_MINGW_ONLY_SYMBOLS                           \
      SymI_HasProto(__INFL)                              \
      SymI_HasProto(__bigtens_D2A)                       \
      SymI_HasProto(__hexdig_D2A)                        \
      SymI_HasProto(__image_base__)                      \
      SymI_HasProto(__imp___argv)                        \
      SymI_HasProto(__imp___mb_cur_max)                  \
      SymI_HasProto(__imp___pioinfo)                     \
      SymI_HasProto(__imp__fpreset)                      \
      SymI_HasProto(__imp__osver)                        \
      SymI_HasProto(__pfnDliFailureHook2)                \
      SymI_HasProto(__pfnDliNotifyHook2)                 \
      SymI_HasProto(__tens_D2A)                          \
      SymI_HasProto(__tinytens_D2A)                      \
      SymI_HasProto(mingw_app_type)                      \
      SymI_HasProto(signgam)                             \
      SymI_HasProto(StringCatExWorkerA)                  \
      SymI_HasProto(StringCatExWorkerW)                  \
      SymI_HasProto(StringCatNExWorkerA)                 \
      SymI_HasProto(StringCatNExWorkerW)                 \
      SymI_HasProto(StringCatNWorkerA)                   \
      SymI_HasProto(StringCatNWorkerW)                   \
      SymI_HasProto(StringCatWorkerA)                    \
      SymI_HasProto(StringCatWorkerW)                    \
      SymI_HasProto(StringCbCatA)                        \
      SymI_HasProto(StringCbCatExA)                      \
      SymI_HasProto(StringCbCatExW)                      \
      SymI_HasProto(StringCbCatNA)                       \
      SymI_HasProto(StringCbCatNExA)                     \
      SymI_HasProto(StringCbCatNExW)                     \
      SymI_HasProto(StringCbCatNW)                       \
      SymI_HasProto(StringCbCatW)                        \
      SymI_HasProto(StringCbCopyA)                       \
      SymI_HasProto(StringCbCopyExA)                     \
      SymI_HasProto(StringCbCopyExW)                     \
      SymI_HasProto(StringCbCopyNA)                      \
      SymI_HasProto(StringCbCopyNExA)                    \
      SymI_HasProto(StringCbCopyNExW)                    \
      SymI_HasProto(StringCbCopyNW)                      \
      SymI_HasProto(StringCbCopyW)                       \
      SymI_HasProto(StringCbGetsA)                       \
      SymI_HasProto(StringCbGetsExA)                     \
      SymI_HasProto(StringCbGetsExW)                     \
      SymI_HasProto(StringCbGetsW)                       \
      SymI_HasProto(StringCbLengthA)                     \
      SymI_HasProto(StringCbLengthW)                     \
      SymI_HasProto(StringCbPrintfA)                     \
      SymI_HasProto(StringCbPrintfExA)                   \
      SymI_HasProto(StringCbPrintfExW)                   \
      SymI_HasProto(StringCbPrintfW)                     \
      SymI_HasProto(StringCbVPrintfA)                    \
      SymI_HasProto(StringCbVPrintfExA)                  \
      SymI_HasProto(StringCbVPrintfExW)                  \
      SymI_HasProto(StringCbVPrintfW)                    \
      SymI_HasProto(StringCchCatA)                       \
      SymI_HasProto(StringCchCatExA)                     \
      SymI_HasProto(StringCchCatExW)                     \
      SymI_HasProto(StringCchCatNA)                      \
      SymI_HasProto(StringCchCatNExA)                    \
      SymI_HasProto(StringCchCatNExW)                    \
      SymI_HasProto(StringCchCatNW)                      \
      SymI_HasProto(StringCchCatW)                       \
      SymI_HasProto(StringCchCopyA)                      \
      SymI_HasProto(StringCchCopyExA)                    \
      SymI_HasProto(StringCchCopyExW)                    \
      SymI_HasProto(StringCchCopyNA)                     \
      SymI_HasProto(StringCchCopyNExA)                   \
      SymI_HasProto(StringCchCopyNExW)                   \
      SymI_HasProto(StringCchCopyNW)                     \
      SymI_HasProto(StringCchCopyW)                      \
      SymI_HasProto(StringCchGetsA)                      \
      SymI_HasProto(StringCchGetsExA)                    \
      SymI_HasProto(StringCchGetsExW)                    \
      SymI_HasProto(StringCchGetsW)                      \
      SymI_HasProto(StringCchLengthA)                    \
      SymI_HasProto(StringCchLengthW)                    \
      SymI_HasProto(StringCchPrintfA)                    \
      SymI_HasProto(StringCchPrintfExA)                  \
      SymI_HasProto(StringCchPrintfExW)                  \
      SymI_HasProto(StringCchPrintfW)                    \
      SymI_HasProto(StringCchVPrintfA)                   \
      SymI_HasProto(StringCchVPrintfExA)                 \
      SymI_HasProto(StringCchVPrintfExW)                 \
      SymI_HasProto(StringCchVPrintfW)                   \
      SymI_HasProto(StringCopyExWorkerA)                 \
      SymI_HasProto(StringCopyExWorkerW)                 \
      SymI_HasProto(StringCopyNExWorkerA)                \
      SymI_HasProto(StringCopyNExWorkerW)                \
      SymI_HasProto(StringCopyNWorkerA)                  \
      SymI_HasProto(StringCopyNWorkerW)                  \
      SymI_HasProto(StringCopyWorkerA)                   \
      SymI_HasProto(StringCopyWorkerW)                   \
      SymI_HasProto(StringGetsExWorkerA)                 \
      SymI_HasProto(StringGetsExWorkerW)                 \
      SymI_HasProto(StringLengthWorkerA)                 \
      SymI_HasProto(StringLengthWorkerW)                 \
      SymI_HasProto(StringVPrintfExWorkerA)              \
      SymI_HasProto(StringVPrintfExWorkerW)              \
      SymI_HasProto(StringVPrintfWorkerA)                \
      SymI_HasProto(StringVPrintfWorkerW)                \
      SymI_HasProto(_Exit)                               \
      SymI_HasProto(__Balloc_D2A)                        \
      SymI_HasProto(__Bfree_D2A)                         \
      SymI_HasProto(__DENORM)                            \
      SymI_HasProto(__DENORMF)                           \
      SymI_HasProto(__DENORML)                           \
      SymI_HasProto(__FUnloadDelayLoadedDLL2)            \
      SymI_HasProto(__HrLoadAllImportsForDll)            \
      SymI_HasProto(__INF)                               \
      SymI_HasProto(__INFF)                              \
      SymI_HasProto(__QNAN)                              \
      SymI_HasProto(__QNANF)                             \
      SymI_HasProto(__QNANL)                             \
      SymI_HasProto(__SNAN)                              \
      SymI_HasProto(__SNANF)                             \
      SymI_HasProto(__SNANL)                             \
      SymI_HasProto(__any_on_D2A)                        \
      SymI_HasProto(__asctoe64)                          \
      SymI_HasProto(__b2d_D2A)                           \
      SymI_HasProto(__cmp_D2A)                           \
      SymI_HasProto(__copybits_D2A)                      \
      SymI_HasProto(__cosl_internal)                     \
      SymI_HasProto(__d2b_D2A)                           \
      SymI_HasProto(__decrement_D2A)                     \
      SymI_HasProto(__delayLoadHelper2)                  \
      SymI_HasProto(__diff_D2A)                          \
      SymI_HasProto(__dtoa)                              \
      SymI_HasProto(__eaddm)                             \
      SymI_HasProto(__ecmp)                              \
      SymI_HasProto(__edivm)                             \
      SymI_HasProto(__emdnorm)                           \
      SymI_HasProto(__emovi)                             \
      SymI_HasProto(__emovo)                             \
      SymI_HasProto(__emul)                              \
      SymI_HasProto(__emulm)                             \
      SymI_HasProto(__enormlz)                           \
      SymI_HasProto(__eshift)                            \
      SymI_HasProto(__esubm)                             \
      SymI_HasProto(__fp_unordered_compare)              \
      SymI_HasProto(__fpclassify)                        \
      SymI_HasProto(__fpclassifyf)                       \
      SymI_HasProto(__fpclassifyl)                       \
      SymI_HasProto(__freedtoa)                          \
      SymI_HasProto(__g__fmt)                            \
      SymI_HasProto(__g_dfmt)                            \
      SymI_HasProto(__g_ffmt)                            \
      SymI_HasProto(__g_xfmt)                            \
      SymI_HasProto(__gdtoa)                             \
      SymI_HasProto(__gethex_D2A)                        \
      SymI_HasProto(__hexnan_D2A)                        \
      SymI_HasProto(__i2b_D2A)                           \
      SymI_HasProto(__imp_fstat)                         \
      SymI_HasProto(__imp_stat)                          \
      SymI_HasProto(__increment_D2A)                     \
      SymI_HasProto(__isnan)                             \
      SymI_HasProto(__isnanf)                            \
      SymI_HasProto(__isnanl)                            \
      SymI_HasProto(__lgamma_r)                          \
      SymI_HasProto(__lgammaf_r)                         \
      SymI_HasProto(__lgammal_r)                         \
      SymI_HasProto(__logl_internal)                     \
      SymI_HasProto(__lshift_D2A)                        \
      SymI_HasProto(__match_D2A)                         \
      SymI_HasProto(__mingw_aligned_free)                \
      SymI_HasProto(__mingw_aligned_malloc)              \
      SymI_HasProto(__mingw_aligned_offset_malloc)       \
      SymI_HasProto(__mingw_aligned_offset_realloc)      \
      SymI_HasProto(__mingw_aligned_realloc)             \
      SymI_HasProto(__mingw_asprintf)                    \
      SymI_HasProto(__mingw_fprintf)                     \
      SymI_HasProto(__mingw_fscanf)                      \
      SymI_HasProto(__mingw_fseek)                       \
      SymI_HasProto(__mingw_fseeko64)                    \
      SymI_HasProto(__mingw_fwprintf)                    \
      SymI_HasProto(__mingw_fwrite)                      \
      SymI_HasProto(__mingw_fwscanf)                     \
      SymI_HasProto(__mingw_has_sse)                     \
      SymI_HasProto(__mingw_hexdig_init_D2A)             \
      SymI_HasProto(__mingw_optreset)                    \
      SymI_HasProto(__mingw_pformat)                     \
      SymI_HasProto(__mingw_printf)                      \
      SymI_HasProto(__mingw_scanf)                       \
      SymI_HasProto(__mingw_snprintf)                    \
      SymI_HasProto(__mingw_snwprintf)                   \
      SymI_HasProto(__mingw_sprintf)                     \
      SymI_HasProto(__mingw_sscanf)                      \
      SymI_HasProto(__mingw_str_free)                    \
      SymI_HasProto(__mingw_str_utf8_wide)               \
      SymI_HasProto(__mingw_str_wide_utf8)               \
      SymI_HasProto(__mingw_strtod)                      \
      SymI_HasProto(__mingw_strtof)                      \
      SymI_HasProto(__mingw_strtold)                     \
      SymI_HasProto(__mingw_swprintf)                    \
      SymI_HasProto(__mingw_swscanf)                     \
      SymI_HasProto(__mingw_vasprintf)                   \
      SymI_HasProto(__mingw_vfprintf)                    \
      SymI_HasProto(__mingw_vfscanf)                     \
      SymI_HasProto(__mingw_vfwprintf)                   \
      SymI_HasProto(__mingw_vfwscanf)                    \
      SymI_HasProto(__mingw_vprintf)                     \
      SymI_HasProto(__mingw_vscanf)                      \
      SymI_HasProto(__mingw_vsnprintf)                   \
      SymI_HasProto(__mingw_vsnwprintf)                  \
      SymI_HasProto(__mingw_vsprintf)                    \
      SymI_HasProto(__mingw_vsscanf)                     \
      SymI_HasProto(__mingw_vswprintf)                   \
      SymI_HasProto(__mingw_vswscanf)                    \
      SymI_HasProto(__mingw_vwprintf)                    \
      SymI_HasProto(__mingw_vwscanf)                     \
      SymI_HasProto(__mingw_wcstod)                      \
      SymI_HasProto(__mingw_wcstof)                      \
      SymI_HasProto(__mingw_wcstold)                     \
      SymI_HasProto(__mingw_wpformat)                    \
      SymI_HasProto(__mingw_wprintf)                     \
      SymI_HasProto(__mingw_wscanf)                      \
      SymI_HasProto(__ms_snprintf)                       \
      SymI_HasProto(__ms_snwprintf)                      \
      SymI_HasProto(__ms_vfscanf)                        \
      SymI_HasProto(__ms_vfwscanf)                       \
      SymI_HasProto(__ms_vscanf)                         \
      SymI_HasProto(__ms_vsnprintf)                      \
      SymI_HasProto(__ms_vsnwprintf)                     \
      SymI_HasProto(__ms_vsscanf)                        \
      SymI_HasProto(__ms_vswscanf)                       \
      SymI_HasProto(__ms_vwscanf)                        \
      SymI_HasProto(__mult_D2A)                          \
      SymI_HasProto(__multadd_D2A)                       \
      SymI_HasProto(__nrv_alloc_D2A)                     \
      SymI_HasProto(__pow5mult_D2A)                      \
      SymI_HasProto(__powi)                              \
      SymI_HasProto(__powif)                             \
      SymI_HasProto(__powil)                             \
      SymI_HasProto(__puiHead)                           \
      SymI_HasProto(__quorem_D2A)                        \
      SymI_HasProto(__ratio_D2A)                         \
      SymI_HasProto(__rshift_D2A)                        \
      SymI_HasProto(__rv_alloc_D2A)                      \
      SymI_HasProto(__s2b_D2A)                           \
      SymI_HasProto(__set_ones_D2A)                      \
      SymI_HasProto(__signbit)                           \
      SymI_HasProto(__signbitf)                          \
      SymI_HasProto(__signbitl)                          \
      SymI_HasProto(__sinl_internal)                     \
      SymI_HasProto(__strcp_D2A)                         \
      SymI_HasProto(__strtod)                            \
      SymI_HasProto(__strtodg)                           \
      SymI_HasProto(__strtof)                            \
      SymI_HasProto(__strtold)                           \
      SymI_HasProto(__sum_D2A)                           \
      SymI_HasProto(__tgamma_r)                          \
      SymI_HasProto(__tgammaf_r)                         \
      SymI_HasProto(__tgammal_r)                         \
      SymI_HasProto(__toe64)                             \
      SymI_HasProto(__trailz_D2A)                        \
      SymI_HasProto(__ulp_D2A)                           \
      SymI_HasProto(_abs64)                              \
      SymI_HasProto(_assert)                             \
      SymI_HasProto(_byteswap_uint64)                    \
      SymI_HasProto(_byteswap_ulong)                     \
      SymI_HasProto(_byteswap_ushort)                    \
      SymI_HasProto(_cabs)                               \
      SymI_HasProto(_chgsignl)                           \
      SymI_HasProto(_difftime32)                         \
      SymI_HasProto(_difftime64)                         \
      SymI_HasProto(_findfirst64i32)                     \
      SymI_HasProto(_findnext64i32)                      \
      SymI_HasProto(_flush)                              \
      SymI_HasProto(_fseeki64)                           \
      SymI_HasProto(_fstat64i32)                         \
      SymI_HasProto(_ftelli64)                           \
      SymI_HasProto(_get_errno)                          \
      SymI_HasProto(_getc_nolock)                        \
      SymI_HasProto(_getwc_nolock)                       \
      SymI_HasProto(_putc_nolock)                        \
      SymI_HasProto(_putwc_nolock)                       \
      SymI_HasProto(_set_errno)                          \
      SymI_HasProto(_stat64i32)                          \
      SymI_HasProto(_wassert)                            \
      SymI_HasProto(_wclosedir)                          \
      SymI_HasProto(_wfindfirst64i32)                    \
      SymI_HasProto(_wfindnext64i32)                     \
      SymI_HasProto(_wopendir)                           \
      SymI_HasProto(_wreaddir)                           \
      SymI_HasProto(_wrewinddir)                         \
      SymI_HasProto(_wseekdir)                           \
      SymI_HasProto(_wstat64i32)                         \
      SymI_HasProto(_wtelldir)                           \
      SymI_HasProto(acosf)                               \
      SymI_HasProto(acosh)                               \
      SymI_HasProto(acoshf)                              \
      SymI_HasProto(acoshl)                              \
      SymI_HasProto(acosl)                               \
      SymI_HasProto(alarm)                               \
      SymI_HasProto(asinf)                               \
      SymI_HasProto(asinh)                               \
      SymI_HasProto(asinhf)                              \
      SymI_HasProto(asinhl)                              \
      SymI_HasProto(asinl)                               \
      SymI_HasProto(asprintf)                            \
      SymI_HasProto(atan2)                               \
      SymI_HasProto(atan2f)                              \
      SymI_HasProto(atan2l)                              \
      SymI_HasProto(atanf)                               \
      SymI_HasProto(atanh)                               \
      SymI_HasProto(atanhf)                              \
      SymI_HasProto(atanhl)                              \
      SymI_HasProto(atanl)                               \
      SymI_HasProto(atoll)                               \
      SymI_HasProto(basename)                            \
      SymI_HasProto(btowc)                               \
      SymI_HasProto(c16rtomb)                            \
      SymI_HasProto(c32rtomb)                            \
      SymI_HasProto(cabs)                                \
      SymI_HasProto(cabsf)                               \
      SymI_HasProto(cabsl)                               \
      SymI_HasProto(cacos)                               \
      SymI_HasProto(cacosf)                              \
      SymI_HasProto(cacosh)                              \
      SymI_HasProto(cacoshf)                             \
      SymI_HasProto(cacoshl)                             \
      SymI_HasProto(cacosl)                              \
      SymI_HasProto(carg)                                \
      SymI_HasProto(cargf)                               \
      SymI_HasProto(cargl)                               \
      SymI_HasProto(casin)                               \
      SymI_HasProto(casinf)                              \
      SymI_HasProto(casinh)                              \
      SymI_HasProto(casinhf)                             \
      SymI_HasProto(casinhl)                             \
      SymI_HasProto(casinl)                              \
      SymI_HasProto(catan)                               \
      SymI_HasProto(catanf)                              \
      SymI_HasProto(catanh)                              \
      SymI_HasProto(catanhf)                             \
      SymI_HasProto(catanhl)                             \
      SymI_HasProto(catanl)                              \
      SymI_HasProto(cbrt)                                \
      SymI_HasProto(cbrtf)                               \
      SymI_HasProto(cbrtl)                               \
      SymI_HasProto(ccos)                                \
      SymI_HasProto(ccosf)                               \
      SymI_HasProto(ccosh)                               \
      SymI_HasProto(ccoshf)                              \
      SymI_HasProto(ccoshl)                              \
      SymI_HasProto(ccosl)                               \
      SymI_HasProto(ceil)                                \
      SymI_HasProto(ceilf)                               \
      SymI_HasProto(ceill)                               \
      ...
      SymI_HasProto(cexpl)                               \
      SymI_HasProto(cimag)                               \
      SymI_HasProto(cimagf)                              \
      SymI_HasProto(cimagl)                              \
      SymI_HasProto(clog)                                \
      SymI_HasProto(clogf)                               \
      SymI_HasProto(clogl)                               \
      SymI_HasProto(closedir)                            \
      ...
      SymI_HasProto(conjf)                               \
      SymI_HasProto(conjl)                               \
      SymI_HasProto(copysign)                            \
      SymI_HasProto(copysignf)                           \
      SymI_HasProto(copysignl)                           \
      SymI_HasProto(cos)                                 \
      SymI_HasProto(cosf)                                \
      SymI_HasProto(coshf)                               \
      SymI_HasProto(coshl)                               \
      ...
      SymI_HasProto(cpowl)                               \
      SymI_HasProto(cproj)                               \
      SymI_HasProto(cprojf)                              \
      SymI_HasProto(cprojl)                              \
      SymI_HasProto(creal)                               \
      SymI_HasProto(crealf)                              \
      SymI_HasProto(creall)                              \
      SymI_HasProto(csin)                                \
      SymI_HasProto(csinf)                               \
      SymI_HasProto(csinh)                               \
      SymI_HasProto(csinhf)                              \
      SymI_HasProto(csinhl)                              \
      SymI_HasProto(csinl)                               \
      SymI_HasProto(csqrt)                               \
      SymI_HasProto(csqrtf)                              \
      SymI_HasProto(csqrtl)                              \
      SymI_HasProto(ctan)                                \
      SymI_HasProto(ctanf)                               \
      SymI_HasProto(ctanh)                               \
      SymI_HasProto(ctanhf)                              \
      SymI_HasProto(ctanhl)                              \
      SymI_HasProto(ctanl)                               \
      SymI_HasProto(difftime)                            \
      SymI_HasProto(dirname)                             \
      SymI_HasProto(erf)                                 \
      SymI_HasProto(erfc)                                \
      SymI_HasProto(erfcf)                               \
      SymI_HasProto(erfcl)                               \
      ...
      SymI_HasProto(erfl)                                \
      SymI_HasProto(execv)                               \
      SymI_HasProto(execve)                              \
      SymI_HasProto(execvp)                              \
      SymI_HasProto(execvpe)                             \
      SymI_HasProto(exp)                                 \
      SymI_HasProto(exp2)                                \
      SymI_HasProto(exp2f)                               \
      SymI_HasProto(exp2l)                               \
      ...
      SymI_HasProto(fdimf)                               \
      SymI_HasProto(fdiml)                               \
      SymI_HasProto(feclearexcept)                       \
      SymI_HasProto(fegetenv)                            \
      SymI_HasProto(fegetexceptflag)                     \
      SymI_HasProto(fegetround)                          \
      SymI_HasProto(feholdexcept)                        \
      SymI_HasProto(feraiseexcept)                       \
      SymI_HasProto(fesetenv)                            \
      SymI_HasProto(fesetexceptflag)                     \
      SymI_HasProto(fesetround)                          \
      SymI_HasProto(fetestexcept)                        \
      SymI_HasProto(feupdateenv)                         \
      SymI_HasProto(fgetpos64)                           \
      SymI_HasProto(floor)                               \
      SymI_HasProto(floorf)                              \
      SymI_HasProto(floorl)                              \
      SymI_HasProto(fma)                                 \
      SymI_HasProto(fmaf)                                \
      SymI_HasProto(fmal)                                \
      SymI_HasProto(fmax)                                \
      ...
      SymI_HasProto(fmodf)                               \
      SymI_HasProto(fmodl)                               \
      SymI_HasProto(fopen64)                             \
      SymI_HasProto(frexpf)                              \
      SymI_HasProto(frexpl)                              \
      SymI_HasProto(fseeko)                              \
      SymI_HasProto(fseeko64)                            \
      SymI_HasProto(fsetpos64)                           \
      SymI_HasProto(fstat)                               \
      SymI_HasProto(ftello)                              \
      SymI_HasProto(ftello64)                            \
      SymI_HasProto(ftime)                               \
      SymI_HasProto(ftruncate)                           \
      SymI_HasProto(ftruncate64)                         \
      SymI_HasProto(ftw)                                 \
      SymI_HasProto(ftw64)                               \
      SymI_HasProto(fwide)                               \
      SymI_HasProto(getlogin)                            \
      SymI_HasProto(getntptimeofday)                     \
      SymI_HasProto(getopt)                              \
      SymI_HasProto(getopt_long)                         \
      SymI_HasProto(getopt_long_only)                    \
      SymI_HasProto(gettimeofday)                        \
      SymI_HasProto(hypot)                               \
      SymI_HasProto(hypotf)                              \
      SymI_HasProto(hypotl)                              \
      SymI_HasProto(ilogb)                               \
      SymI_HasProto(ilogbf)                              \
      SymI_HasProto(ilogbl)                              \
      SymI_HasProto(imaxabs)                             \
      SymI_HasProto(imaxdiv)                             \
      SymI_HasProto(isblank)                             \
      SymI_HasProto(isnan)                               \
      SymI_HasProto(isnanf)                              \
      SymI_HasProto(isnanl)                              \
      SymI_HasProto(iswblank)                            \
      SymI_HasProto(ldexp)                               \
      SymI_HasProto(ldexpf)                              \
      SymI_HasProto(ldexpl)                              \
      SymI_HasProto(lgamma)                              \
      SymI_HasProto(lgammaf)                             \
      SymI_HasProto(lgammal)                             \
      SymI_HasProto(llabs)                               \
      SymI_HasProto(lldiv)                               \
      SymI_HasProto(llrint)                              \
      SymI_HasProto(llrintf)                             \
      SymI_HasProto(llrintl)                             \
      SymI_HasProto(llround)                             \
      SymI_HasProto(llroundf)                            \
      SymI_HasProto(llroundl)                            \
      SymI_HasProto(lltoa)                               \
      SymI_HasProto(lltow)                               \
      SymI_HasProto(log)                                 \
      SymI_HasProto(log10f)                              \
      SymI_HasProto(log10l)                              \
      SymI_HasProto(log1p)                               \
      SymI_HasProto(log1pf)                              \
      SymI_HasProto(log1pl)                              \
      SymI_HasProto(log2)                                \
      SymI_HasProto(log2f)                               \
      SymI_HasProto(log2l)                               \
      SymI_HasProto(logb)                                \
      ...
      SymI_HasProto(logf)                                \
      SymI_HasProto(logl)                                \
      SymI_HasProto(longjmp)                             \
      SymI_HasProto(lrint)                               \
      SymI_HasProto(lrintf)                              \
      SymI_HasProto(lrintl)                              \
      SymI_HasProto(lround)                              \
      SymI_HasProto(lroundf)                             \
      SymI_HasProto(lroundl)                             \
      SymI_HasProto(lseek64)                             \
      SymI_HasProto(mbrlen)                              \
      SymI_HasProto(mbrtoc16)                            \
      SymI_HasProto(mbrtoc32)                            \
      SymI_HasProto(mbrtowc)                             \
      SymI_HasProto(mbsinit)                             \
      SymI_HasProto(mbsrtowcs)                           \
      SymI_HasProto(mempcpy)                             \
      SymI_HasProto(mingw_dosmaperr)                     \
      SymI_HasProto(mingw_getsp)                         \
      SymI_HasProto(mingw_gettimeofday)                  \
      SymI_HasProto(mkstemp)                             \
      SymI_HasProto(modf)                                \
      SymI_HasProto(modff)                               \
      SymI_HasProto(modfl)                               \
      SymI_HasProto(nan)                                 \
      SymI_HasProto(nanf)                                \
      SymI_HasProto(nanl)                                \
      SymI_HasProto(nearbyint)                           \
      SymI_HasProto(nearbyintf)                          \
      SymI_HasProto(nearbyintl)                          \
      SymI_HasProto(nextafterf)                          \
      SymI_HasProto(nextafterl)                          \
      SymI_HasProto(nexttoward)                          \
      SymI_HasProto(nexttowardf)                         \
      SymI_HasProto(nexttowardl)                         \
      SymI_HasProto(nftw)                                \
      SymI_HasProto(nftw64)                              \
      SymI_HasProto(opendir)                             \
      SymI_HasProto(optarg)                              \
      SymI_HasProto(opterr)                              \
      SymI_HasProto(optind)                              \
      SymI_HasProto(optopt)                              \
      SymI_HasProto(pow)                                 \
      SymI_HasProto(powf)                                \
      SymI_HasProto(powl)                                \
      SymI_HasProto(readdir)                             \
      SymI_HasProto(remainder)                           \
      SymI_HasProto(remainderf)                          \
      SymI_HasProto(remainderl)                          \
      SymI_HasProto(remquo)                              \
      SymI_HasProto(remquof)                             \
      SymI_HasProto(remquol)                             \
      SymI_HasProto(rewinddir)                           \
      SymI_HasProto(rint)                                \
      SymI_HasProto(rintf)                               \
      SymI_HasProto(rintl)                               \
      SymI_HasProto(round)                               \
      SymI_HasProto(roundf)                              \
      SymI_HasProto(roundl)                              \
      SymI_HasProto(scalbln)                             \
      SymI_HasProto(scalblnf)                            \
      SymI_HasProto(scalblnl)                            \
      SymI_HasProto(scalbn)                              \
      SymI_HasProto(scalbnf)                             \
      SymI_HasProto(scalbnl)                             \
      SymI_HasProto(seekdir)                             \
      SymI_HasProto(signbit)                             \
      SymI_HasProto(signbitf)                            \
      SymI_HasProto(signbitl)                            \
      SymI_HasProto(sin)                                 \
      SymI_HasProto(sincos)                              \
      SymI_HasProto(sincosf)                             \
      SymI_HasProto(sincosl)                             \
      SymI_HasProto(sinf)                                \
      SymI_HasProto(sinhf)                               \
      SymI_HasProto(sinhl)                               \
      SymI_HasProto(sinl)                                \
      SymI_HasProto(sleep)                               \
      SymI_HasProto(spawnv)                              \
      SymI_HasProto(spawnve)                             \
      SymI_HasProto(spawnvp)                             \
      SymI_HasProto(spawnvpe)                            \
      SymI_HasProto(sqrt)                                \
      SymI_HasProto(sqrtf)                               \
      SymI_HasProto(sqrtl)                               \
      SymI_HasProto(stat)                                \
      SymI_HasProto(strnlen)                             \
      SymI_HasProto(strtof)                              \
      SymI_HasProto(strtoimax)                           \
      SymI_HasProto(strtok_r)                            \
      SymI_HasProto(strtold)                             \
      SymI_HasProto(strtoll)                             \
      SymI_HasProto(strtoull)                            \
      SymI_HasProto(strtoumax)                           \
      SymI_HasProto(tanf)                                \
      SymI_HasProto(tanhf)                               \
      SymI_HasProto(tanhl)                               \
      SymI_HasProto(tanl)                                \
      SymI_HasProto(tdelete)                             \
      SymI_HasProto(telldir)                             \
      SymI_HasProto(tfind)                               \
      SymI_HasProto(tgamma)                              \
      SymI_HasProto(tgammaf)                             \
      SymI_HasProto(tgammal)                             \
      SymI_HasProto(towctrans)                           \
      SymI_HasProto(trunc)                               \
      SymI_HasProto(truncate)                            \
      SymI_HasProto(truncate64)                          \
      SymI_HasProto(truncf)                              \
      SymI_HasProto(truncl)                              \
      SymI_HasProto(tsearch)                             \
      SymI_HasProto(twalk)                               \
      SymI_HasProto(ulltoa)                              \
      SymI_HasProto(ulltow)                              \
      SymI_HasProto(usleep)                              \
      SymI_HasProto(vasprintf)                           \
      SymI_HasProto(vfscanf)                             \
      SymI_HasProto(vfwscanf)                            \
      SymI_HasProto(vscanf)                              \
      SymI_HasProto(vsnprintf_s)                         \
      SymI_HasProto(vsscanf)                             \
      SymI_HasProto(vswscanf)                            \
      SymI_HasProto(vwscanf)                             \
      SymI_HasProto(wcrtomb)                             \
      SymI_HasProto(wcsnlen)                             \
      SymI_HasProto(wcsrtombs)                           \
      SymI_HasProto(wcstof)                              \
      SymI_HasProto(wcstoimax)                           \
      SymI_HasProto(wcstold)                             \
      SymI_HasProto(wcstoll)                             \
      SymI_HasProto(wcstoull)                            \
      SymI_HasProto(wcstoumax)                           \
      SymI_HasProto(wctob)                               \
      SymI_HasProto(wctrans)                             \
      SymI_HasProto(wctype)                              \
      SymI_HasProto(wmemchr)                             \
      SymI_HasProto(wmemcmp)                             \
      SymI_HasProto(wmemcpy)                             \
      SymI_HasProto(wmemmove)                            \
      SymI_HasProto(wmempcpy)                            \
      SymI_HasProto(wmemset)                             \
      SymI_HasProto(wstat)                               \
      SymI_HasProto(wtoll)                               \
